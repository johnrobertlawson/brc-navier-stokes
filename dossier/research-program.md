...
bounded tensor
\(Z_\eta=\omega\otimes\omega/(|\omega|+\eta)^2\), or equivalently its two-scale
polar Young measure. The remaining theorem must propagate or eliminate the
vacuum part and its cutoff-scale diffusion defect before suitable ancient
rigidity can apply.
